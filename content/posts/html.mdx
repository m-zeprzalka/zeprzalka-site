...
> :computer: HTML narodził się z potrzeby, a nie dla zysku. Fizyk [Tim Berners-Lee](https://pl.wikipedia.org/wiki/Tim_Berners-Lee) stworzył go w 1991 roku w CERN, aby naukowcy mogli w końcu łatwo dzielić się wynikami badań.
...
- **VS Code** - najczęściej używany edytor kodu :rocket:
