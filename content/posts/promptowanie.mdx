...
description: "To nie jest kolejny artykuł o ChatGPT. To kompendium wiedzy o inżynierii promptów (np.CO-STAR, CRISP), przegląd narzędzi (Cursor, Githu Copilot) i workflow, który zmienia juniora w seniora (prawie :D), wspomaganego przez LLM."
date: "2025-12-03"
...
1.  **[Cursor](https://www.cursor.com/)** – **Nowy Standard.**
